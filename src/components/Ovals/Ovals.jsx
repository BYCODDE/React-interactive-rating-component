  ...
  return (
    <section className="oval_section">
      <div onClick={() => handleClick(1)}>
        ...
        {submit === 1 && buttonClicked ? <p>You selected {submit} out of 5</p> : null}
      </div>
      <div onClick={() => handleClick(2)}>
        <img src={Oval} alt="Oval2" />
        <p className="img_p">2</p>
        {submit === 2 && buttonClicked ? <p>You selected {submit} out of 5</p> : null}
      </div>
      <div onClick={() => handleClick(3)}>
        <img src={Oval} alt="Oval3" />
        <p className="img_p">3</p>
        {submit === 3 && buttonClicked ? <p>You selected {submit} out of 5</p> : null}
      </div>
      <div onClick={() => handleClick(4)}>
        <img src={Oval} alt="Oval4" />
        <p className="img_p">4</p>
        {submit === 4 && buttonClicked ? <p>You selected {submit} out of 5</p> : null}
      </div>
      <div onClick={() => handleClick(5)}>
        <img src={Oval} alt="Oval5" />
        <p className="img_p">5</p>
        {submit === 5  && buttonClicked ? <p>You selected {submit} out of 5</p> : null}
      </div>
    </section>
  );
}
